# Don't Remove Credit Tg - @finaticgod
# Ask Doubt on telegram @finaticgod
...
OWNER_ID = 8152589217 # Replace with the actual owner's user ID

# List of sudo users (initially empty or pre-populated)
SUDO_USERS = [8152589217,6073936818,1549029970]

AUTH_CHANNEL = -1002656120306
...
keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("🇮🇳ʙᴏᴛ ᴍᴀᴅᴇ ʙʏ🇮🇳" ,url=f"https://t.me/skilledxwarriors") ],
                    [
                    InlineKeyboardButton("🔔ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ🔔" ,url="https://t.me/skilledxwarriors") ],
                    [
                    InlineKeyboardButton("🦋ғᴏʟʟᴏᴡ ᴜs🦋" ,url="https://t.me/skilledxwarriors")                              
                ],           
            ]
      )
...
async def help_command(client: Client, msg: Message):
    help_text = (
        "`/start` - Start the bot⚡\n\n"
        "`/saurabh` - Download and upload files (sudo)🎬\n\n"
...
@bot.on_message(filters.command(["saurabh"]))
async def upload(bot: Client, m: Message):
    ...
    credit = "️[Saurabh](https://t.me/skilledxwarriors)"
    if raw_text3 == '1':
        CR = '[Saurabh](https://t.me/skilledxwarriors)'
    elif raw_text3:
        try:
